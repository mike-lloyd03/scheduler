		...
		jsonData := `[
			{
				...
				"updated": "2024-09-27 05:43:44.357Z",
				"name": "users",
				"type": "auth",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2024-09-27 05:47:12.279Z",
				"name": "orgs",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2024-09-27 06:13:44.148Z",
				"name": "groups",
				"type": "base",
				"system": false,
				"schema": [
				...
				"createRule": "@collection.permissions.user ?= @request.auth.id && @collection.permissions.role ?= \"admin\" && @collection.permissions.org ?= @request.data.org",
				...
				"deleteRule": "@collection.permissions.user ?= @request.auth.id && @collection.permissions.role ?= \"admin\" && ((@collection.permissions.group ?= id) || (@collection.permissions.org ?= org))",
				"options": {}
			},
			{
				"id": "vgjqljis1csnkxw",
