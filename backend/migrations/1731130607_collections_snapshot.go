		...
		jsonData := `[
			{
				...
				"updated": "2024-11-09 05:30:51.839Z",
			...
			},
			{
				...
				"updated": "2024-11-09 05:30:51.840Z",
				"name": "role_templates",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2024-11-09 05:36:23.216Z",
				"name": "users",
				"type": "auth",
				"system": false,
				"schema": [
				...
				"indexes": [],
				"listRule": "@request.auth.id != \"\" && (\n  // Users can list their own records\n  id = @request.auth.id ||\n  // Users can list users in their own org\n  orgs:each ?= @request.auth.orgs:each ||\n  (\n    @collection.permissions.user.id ?= @request.auth.id && \n    (\n      // Org admins and managers can list users in their own org\n      orgs:each ?= @collection.permissions.org ||\n      // Group admins and managers can list users in their own group\n      groups:each ?= @collection.permissions.group\n    )\n  )\n)",
